...
const ASSETS_TO_CACHE = [
  ...
  { url: 'https://targetboskval.webcomic.ws/files/icons/chevron-down.svg', revision: '1.0' },
  { url: 'https://targetboskval.webcomic.ws/files/icons/menu-24px.svg', revision: '1.0' },
  { url: 'https://targetboskval.webcomic.ws/files/icons/x-24px.svg', revision: '1.0' },
